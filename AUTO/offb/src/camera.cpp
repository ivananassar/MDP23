...
//static cv::String weightpath ="~/catkin_ws/src/AUTO/offb/src/include/yolo/yt608.weights";
//static cv::String cfgpath ="~/catkin_ws/src/AUTO/offb/src/include/yolo/yt608.cfg";
static cv::String model_path = "/home/ivana/catkin_ws/src/AUTO/offb/src/include/yolo/model_unet-mobilnetv2.h5";

static run_yolo Yolonet(model_path);
...
int main(int argc, char** argv)
{
    ...
    cv::VideoWriter video("/home/ivana/catkin_ws/src/AUTO/offb/src/include/yolo/tracking.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    cv::VideoWriter videoyolo("/home/ivana/catkin_ws/src/AUTO/offb/src/include/yolo/yolo.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    cv::VideoWriter videogt("/home/ivana/catkin_ws/src/AUTO/offb/src/include/yolo/gt.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    ...
    while(ros::ok())
    {
        ...
        if(!frame.empty())
        {
            ...
            if (found)
            {
                ...
                ofstream save("/home/ivana/catkin_ws/src/AUTO/offb/src/include/yolo/gt.txt", ios::app);
                save<<counter<<endl;
            ...
            if(temp.size()!=0)
            {
                for(auto stuff:temp)
                {
                    ...
                    if(stuff.classnameofdetection=="solar panel")
                    {
